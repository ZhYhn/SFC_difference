...
class ConnDataset(Dataset):
    def __init__(self, conn_type, direct, transform=None, pre_transform=None, pre_filter=None):

        self.script_dir = os.path.dirname(os.path.abspath(__file__))
        self.conn_type = conn_type
        self.root = os.path.join(self.script_dir, f'train\\{conn_type}_dataset')
        self.direct = direct
    ...
    def processed_file_names(self):
        return [f'data_{i}.pt' for i in range(3592)]
    ...
    def process(self):
        ...
        for raw_path in tqdm(self.raw_paths, total=len(self.raw_paths)):
            ...
            if self.direct != None:
                ...
                adj_matrix_new[self.direct, :] = adj_matrix[self.direct, :]
                adj_matrix_new[:, self.direct] = adj_matrix[:, self.direct]
                adj_matrix = adj_matrix_new
